...
class AdvocateController extends Controller
{
    ...
    public function create()
    {
        ...
        if(Auth::user()->can('create advocate')){
            $branches = Branch::get();
            return view('advocate.create',compact('branches'));
     ...
     try{
            if(Auth::user()->can('create advocate')){
                ...
                $user = Auth::user();
                    ...
                    $advocate['branch_id']            = $request->branch;
                    ...
                    $advocate->save();
                    DB::commit();
                    return json_encode(array('status' => 'success', 'url' => back()->with('success',  __('Advocate successfully created.'))));
            }else{
                return redirect()->back()->with('error', __('Permission Denied.'));
    ...
    public function edit($id)
    {
        if (Auth::user()->can('edit advocate')) {
            ...
            if($advocate){
                ...
                $branches = Branch::get();
                return view('advocate.edit',compact('advocate','contacts','userAdd','branches'));
            }else{
    ...
    public function update(Request $request, $id)
    {
        try{
            if (Auth::user()->can('edit advocate')) {
                ...
                return json_encode(array('status' => 'success', 'url' => back()->with('success',  __('Advocate successfully updated.'))));
