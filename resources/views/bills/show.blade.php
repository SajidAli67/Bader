...
@section('action-button')
    ...
    <div class="row justify-content-between align-items-center mb-3">
        ...
        <div class="all-button-box mx-2 mr-2">
                <a href="{{ route('bill.print', $bill->id)}}"  class="btn btn-sm btn-primary print-invoice" title="{{ __('print') }}"
...
//             console.log(result)
//             window.open(result, '_blank', 'width=800,height=600');
//         //     setTimeout(function() {
//         //         //window.print();
