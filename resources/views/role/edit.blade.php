                        ...
                        <div class="table-border-style">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    @php
                                        $modules=['dashboard','client','advocate','document','doctype','member','group','court','highcourt','bench','cause','case','todo','bill','tax','diary','timesheet','expense','feereceived','calendar','motions','setting','contract'];
