...
@section('content')
    ...
    {{ Form::model($case, ['route' => ['cases.update', $case->id], 'method' => 'put', 'class' => 'frm-submit-data', 'enctype' => 'multipart/form-data']) }}
    <div class="row">
            ...
            <div class="card shadow-none rounded-0 border">
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control choices-js" id="choices-js" name="contract_id">
                                    ...
                                    @foreach($contracts as $contract)
                                        <option value="{{ $contract->id }}" {{ ($contract->id==$case->contract_id) ? 'selected' : ''  }}>{{ $contract->contract_no }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 ">
                            <div class="form-group">
                                {!! Form::label('password', __('Branch'), ['class' => 'form-label required-sym']) !!}
                                <select class="form-control " id="branch" name="branch" required="required">
                                    ...
                                    <option value="{{ $branch->id }}" {{ ($branch->id==$case->branch_id) ? 'selected' : ''  }}>{{ $branch->name }}</option>
                                    @endif
                                    @endforeach
                                </select>
                            </div>
