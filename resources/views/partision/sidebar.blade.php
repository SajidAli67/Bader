        ...
        <div class="navbar-content">
            <ul class="dash-navbar">
                ...
                <li
                    ...
                    <a href="{{ route('client.list') }}" class="dash-link">
                ...
                <li
                    class="dash-item dash-hasmenu {{ in_array(Request::segment(1), ['contract']) ? ' active' : '' }}">
                    <a href="#!" class="dash-link">
                        <span class="dash-micon"><i class="fa fa-compress"></i></span>
                        <span class="dash-mtext">{{ __('Contract') }}</span>
                        <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                    </a>

                    <ul
                        class="dash-submenu {{ in_array(Request::segment(1), ['contract'])  ? 'show' : '' }}">

                        @can('manage contract')
                        <li class="dash-item {{ Request::route()->getName() == 'contract' || Request::route()->getName() == 'contract.add' ? 'active' : '' }}">
                            <a class="dash-link" href="{{ route('contract') }}">{{ __('List') }}</a>
                        </li>
                        @endcan

                        @can('manage contract')
                        <li
                            class="dash-item {{ Request::route()->getName() == 'contract.setting'  ? 'active' : '' }}">
                            <a class="dash-link" href="{{ route('contract.setting') }}">{{ __('Contract Setting') }}</a>
                        </li>
                        @endcan
                ...
                <li
                    ...
                    <ul
                        ...
                        @can('manage contract')
                        <li class="dash-item {{ Request::route()->getName() == 'incomevsexpence'  ? 'active' : '' }}">
                            <a class="dash-link" href="{{ route('incomevsexpence') }}">{{ __('Income Vs Expenses') }}</a>
                        </li>
                        @endcan
                        ...
                        <li
                            class="dash-item {{ Request::route()->getName() == 'contract.setting'  ? 'active' : '' }}">
                            <a class="dash-link" href="{{ route('contract.setting') }}">{{ __('VAT') }}</a>
                        </li>
                        @endcan
            ...
            <li
                class="dash-item dash-hasmenu {{ in_array(Request::segment(1), ['landingpagesetting']) ? ' active' : '' }}">
                <a href="{{ route('landingpagesetting') }}" class="dash-link">
            ...
            <li
                class="dash-item dash-hasmenu  {{ in_array(Request::segment(1), ['landingpagesetting']) ? ' active' : '' }}">
                <a href="{{ route('invoiceSetting') }}" class="dash-link">
                    <span class="dash-micon"><i class="ti ti-license"></i></span><span class="dash-mtext">{{__('Invoice Setting')}}</span>
                </a>
            </li>
            @endif
