                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control " id="client" name="client" required="required">
                                    ...
                                    @foreach($clients as $client)
                                      ...
                                      <option value="{{ $client->id }}" {{  $client->id==$contract->client_id ? 'Selected' :'' }}>{{ $client->name }}</option>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="form-control " id="branch" name="branch" required="required">
                                    ...
                                    <option value="{{ $branch->id }}" {{ ($branch->id==\Auth::user()->branch_id || $branch->id==$contract->branch_id) ? 'selected' : ''  }}>{{ $branch->name }}</option>
                                    @endif
                                    @endforeach
                                </select>
                            </div>
