...
{{ Form::model($advocate,['route' => ['advocate.update',$advocate->id],'method' => 'PUT', 'class' => 'frm-submit-data', 'enctype' => 'multipart/form-data']) }}
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <select class="form-control " id="branch" name="branch" required="required">
                                ...
                                <option value="{{ $branch->id }}" {{ ($branch->id==$advocate->getAdvUser->branch_id) ? 'selected' : ''  }}>{{ $branch->name }}</option>
                                @endif
                                @endforeach
                            </select>
                        </div>
