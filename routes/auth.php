...
Route::middleware('guest')->group(function () {
    ...
    Route::post('login/verify', [AuthenticatedSessionController::class, 'verifyUser'])->name('login.verify');
    Route::get('otp', [AuthenticatedSessionController::class, 'otp'])->name('otp');
    Route::get('regeneratOtp', [AuthenticatedSessionController::class, 'regeneratOtp'])->name('regeneratOtp');
