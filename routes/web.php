...
Route::get('/cash',[FrontendController::class,'cashStudy'])->name('cashstudy');
...
Route::group(['middleware'=>['auth','XSS','verified']], function(){
    ...
    Route::get('/landingpagesetting',[LandingPageSettingController::class,'index'])->name('landingpagesetting');
    Route::post('/landingpagesetting/slider',[LandingPageSettingController::class,'slider'])->name('landingpagesetting.slider');
    Route::post('/landingpagesetting/about',[LandingPageSettingController::class,'about'])->name('landingpagesetting.about');
    Route::post('/landingpagesetting/services',[LandingPageSettingController::class,'services'])->name('landingpagesetting.services');
    Route::post('/landingpagesetting/team',[LandingPageSettingController::class,'team'])->name('landingpagesetting.team');
    Route::post('/landingpagesetting/destroy',[LandingPageSettingController::class,'destroy'])->name('landingpagesetting.destroy');



    Route::get('/invoice',[InvoiceSettingController::class,'index'])->name('invoiceSetting');
    Route::get('/invoice/create',[InvoiceSettingController::class,'create'])->name('invoice.create');
    Route::post('/invoice/store',[InvoiceSettingController::class,'store'])->name('invoice.store');
    ...
    //reports
    Route::get('incomevsexpence', [Reports::class, 'income_vs_expernse'])->name('incomevsexpence');


    //contract

    Route::get('/contract',[ContractController::class,'index'])->name('contract');
    Route::get('/contract/setting',[ContractController::class,'setting'])->name('contract.setting');
    Route::get('/contract/add',[ContractController::class,'add'])->name('contract.add');
    ...
    Route::post('/contract/setting/save',[ContractController::class,'settingSave'])->name('contract.setting.save');
});
